...
function updateMarketData(data) {
    ...
    document.getElementById('accountBalance').textContent = formatCurrency(data.balance || 0);
    document.getElementById('accountEquity').textContent = formatCurrency(data.equity || 0);
    document.getElementById('openPL').textContent = formatCurrency(data.openPL || 0);
...
function updateBotMetrics(data) {
    ...
    if (performanceChart && data.performanceHistory) {
        ...
        performanceChart.data.datasets[0].data = data.performanceHistory.map(p => p.pl);
