...
class EnhancedRiskManager:
    ...
    def optimize_portfolio(self, positions: Dict[str, Dict],
    ...
    def check_correlation_risk(self, symbol: str, direction: str,
    ...
    def calculate_portfolio_metrics(self, positions: Dict[str, Dict],
        ...
        try:
            portfolio_value = sum(pos['size'] * pos['entry_price'] 
            ...
            correlation_risk = self._calculate_correlation_risk(positions, historical_data)
