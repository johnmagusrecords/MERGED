...
Mozilla/5.0 (
    ...
    def _generate_signature(self, timestamp, method, endpoint, body=None):
        ...
        try:
            ...
            signature = hmac.new(
                self.password.encode(), signature_base.encode(), hashlib.sha256
            ).hexdigest()
    ...
    def _authenticate(self):
        ...
        try:
            ...
            signature = self._generate_signature(
                timestamp, "POST", "/session", auth_data
            )
                ...
                if accounts_response.status_code == 200:
                    ...
                    if "accounts" in accounts_data and accounts_data["accounts"]:
                        ...
                        if switch_response.status_code == 200:
                            ...
                            logging.error(
                                f"Failed to switch account: {switch_response.text}"
                            )
                    else:
    ...
    def get_market_price(self, symbol):
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                logging.error(
                    f"Failed to get price: {response.text if response else 'No response'}"
                )
                return None
    ...
    def place_market_order(self, symbol, direction, quantity):
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                logging.error(
                    f"Failed to place order: {response.text if response else 'No response'}"
                )
                return None
    ...
    def get_positions(self):
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                logging.error(
                    f"Failed to get positions: {response.text if response else 'No response'}"
                )
                return []
    ...
    def close_position(self, position_id):
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                logging.error(
                    f"Failed to close position: {response.text if response else 'No response'}"
                )
                return False
