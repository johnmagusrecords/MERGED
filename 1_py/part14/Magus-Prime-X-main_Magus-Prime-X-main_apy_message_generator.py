...
def generate_messages(data_list: list) -> list:
    """Generate messages from a list of data dictionaries."""
    messages = []
    for data in data_list:
        if "text" in data:
            messages.append(data["text"])
        else:
            messages.append(get_signal_message(data))
    return messages
