...
from services.market_data import get_market_data, analyze_market
from services.news import fetch_news, analyze_sentiment
from services.trading import execute_trade, fetch_assets
